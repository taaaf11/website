...
Read more about [creating user controls](/docs#user-controls).
...
[Follow these instructions](/docs#packaging-a-desktop-app) to package your Calculator app into an executable.

## Deploying a web app

[Follow these instructions](/docs#deploying-a-web-app) to deploy your Flet app as a web app to Fly.io or Replit.
